...
class _CreateGroupState extends State<CreateGroup> {
  ...
  void filterContacts() async {
    ...
    for (Contact name in _contacts) {
      var a = name.phones.isEmpty
          ? 0
          : name.phones.first.number.replaceAll(' ', '');
      if (!amar.contains(a)) {
                                    ...
                                    Stack(
                                      children: [
                                        CircleAvatar(
                                          radius: 25,
                                          backgroundColor:
                                              AppColors.cardContainerColor,
                                          child: Center(
                                              child: users[i].profile_image !=
                                                      ""
                                                  ? Text("${users[i].name[0]}",
                                                      textAlign:
                                                          TextAlign.center,
                ...
                ? FloatingActionButton(
                    ...
                    onPressed: () {
                      if (addGroupUser.isEmpty) {
                        EasyLoading.showToast(
                            "Please add at least one user for group!",
                            toastPosition: EasyLoadingToastPosition.bottom);
                      } else {
                        debugPrint("Yes added ${addGroupUser.join(",")}");
