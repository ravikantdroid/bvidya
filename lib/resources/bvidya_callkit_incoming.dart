...
/// * endAllCalls()
///
class BVidyaCallkitIncoming {
  static const MethodChannel _channel =
      MethodChannel('bvidya_callkit_incoming');
  static const EventChannel _eventChannel =
      EventChannel('bvidya_callkit_incoming_events');

  /// Listen to event callback from [BVidyaCallkitIncoming].
  ///
  ...
  /// }
  static Stream<CallEvent2> get onEvent =>
  ...
  static CallEvent2 _receiveCallEvent(dynamic data) {
    var event = "";
    dynamic body = {};
    if (data is Map) {
      event = data['event'];
    ...
    return CallEvent2(event, body);
  }
}

class CallEvent2 {
  static const String ACTION_DID_UPDATE_DEVICE_PUSH_TOKEN_VOIP =
      "com.bvidya.flutter_callkit_incoming.DID_UPDATE_DEVICE_PUSH_TOKEN_VOIP";

  static const String ACTION_CALL_INCOMING =
      "com.bvidya.flutter_callkit_incoming.ACTION_CALL_INCOMING";
  static const String ACTION_CALL_START =
      "com.bvidya.flutter_callkit_incoming.ACTION_CALL_START";
  static const String ACTION_CALL_ACCEPT =
      "com.bvidya.flutter_callkit_incoming.ACTION_CALL_ACCEPT";
  static const String ACTION_CALL_DECLINE =
      "com.bvidya.flutter_callkit_incoming.ACTION_CALL_DECLINE";
  static const String ACTION_CALL_ENDED =
      "com.bvidya.flutter_callkit_incoming.ACTION_CALL_ENDED";
  static const String ACTION_CALL_TIMEOUT =
      "com.bvidya.flutter_callkit_incoming.ACTION_CALL_TIMEOUT";
  static const String ACTION_CALL_CALLBACK =
      "com.bvidya.flutter_callkit_incoming.ACTION_CALL_CALLBACK";
  static const String ACTION_CALL_TOGGLE_HOLD =
      "com.bvidya.flutter_callkit_incoming.ACTION_CALL_TOGGLE_HOLD";
  static const String ACTION_CALL_TOGGLE_MUTE =
      "com.bvidya.flutter_callkit_incoming.ACTION_CALL_TOGGLE_MUTE";
  static const String ACTION_CALL_TOGGLE_DMTF =
      "com.bvidya.flutter_callkit_incoming.ACTION_CALL_TOGGLE_DMTF";
  static const String ACTION_CALL_TOGGLE_GROUP =
      "com.bvidya.flutter_callkit_incoming.ACTION_CALL_TOGGLE_GROUP";
  static const String ACTION_CALL_TOGGLE_AUDIO_SESSION =
      "com.bvidya.flutter_callkit_incoming.ACTION_CALL_TOGGLE_AUDIO_SESSION";

  String name;
  dynamic body;

  CallEvent2(this.name, this.body);
